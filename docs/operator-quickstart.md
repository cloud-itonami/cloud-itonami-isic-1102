# Operator Quickstart — Wine Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1102** (`cloud-itonami-isic-1102`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1102.git
cd cloud-itonami-isic-1102
```
...
- Blueprint governor key: `wineops-governor`
- Likely source path: `wineops.governor.cljc`
