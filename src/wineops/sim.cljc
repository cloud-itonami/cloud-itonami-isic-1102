(ns wineops.sim
  "Simulation driver for testing the wine manufacturing operations actor
  end-to-end.
  ...
  Example flow:
    ...
    3. Propose a batch -> :bottling transition with production parameters
    4. Governor validates parameters against facts
    5. If valid, audit fact is committed
    6. CLI prints audit trail")

(defn -main [& _args]
  (println "WineOps simulation: not yet implemented.")
